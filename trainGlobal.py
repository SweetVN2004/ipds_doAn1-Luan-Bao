...
# # **Áp dụng SMOTE sau khi chuẩn bị xong dữ liệu huấn luyện (X_scaled, y_onehot)**
# from imblearn.over_sampling import SMOTE # type: ignore

# smote = SMOTE()
# X_resampled, y_resampled = smote.fit_resample(X_scaled, y_onehot)
# Xt_resampled, yt_resampled = smote.fit_resample(Xt_scaled, yt_onehot)
